...
namespace Zopoise.Scada.Bak
{
    ...
    public partial class MachineListUC : UserControl
    {
      ...
      {
        new MachineTree() { Id = 1, Name = AppCurrent.Plc.Name, ParentId = 0 ,IsChecked = AppCurrent.Plc.IsEnabled},
        new MachineTree() { Id = 2, Name = AppCurrent.Communicator.Name, ParentId = 0 ,IsChecked = AppCurrent.Communicator.IsEnabled},
        new MachineTree() { Id = 3, Name = "工装板", ParentId = 0,IsChecked = AppCurrent.Testers.Count(t=>t.IsEnabled) == Tester.TesterCount }
      };
            AppCurrent.Testers.ForEach(t =>
            {
                machineTrees.Add(new MachineTree() { Id = t.Id + 3, Name = t.Name, ParentId = 3, IsChecked = t.IsEnabled });
            });
