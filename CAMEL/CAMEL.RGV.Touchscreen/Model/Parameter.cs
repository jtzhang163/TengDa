            ...
            get
            {
                if (parameters == null)
                {
                    parameters = new List<Parameter>() {
                        ...
                        new Parameter{ Name= "运行时间", Addr = "D2004" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "行走定位时间", Addr = "D2005" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "升降定位时间", Addr = "D2006" ,Type = "一般参数",MinValue=0,MaxValue=10000 },
                        new Parameter{ Name= "货叉定位时间", Addr = "D2007" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "行走当前速度", Addr = "D2008" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "升降当前速度", Addr = "D2009" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "货叉当前速度", Addr = "D2010" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "行走加速时间", Addr = "D2020" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "行走减速时间", Addr = "D2021" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "行走目标速度", Addr = "D2022" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "升降加速时间", Addr = "D2023" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "升降减速时间", Addr = "D2024" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "升降目标速度", Addr = "D2025" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "货叉加速时间", Addr = "D2026" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "货叉减速时间", Addr = "D2027" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "货叉目标速度", Addr = "D2028" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "货位号", Addr = "D2029" ,Type = "一般参数" ,MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "行走电机", Addr = "D2036" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "升降电机", Addr = "D2038" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        new Parameter{ Name= "货叉电机", Addr = "D2040" ,Type = "一般参数",MinValue=0,MaxValue=10000},
                        ...
                        new Parameter{ Name= "步号", Addr = "D2061" ,Type = "一般参数",MinValue=0,MaxValue=10000},
