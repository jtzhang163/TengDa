            ...
            get
            {
                if (parameters == null)
                {
                    parameters = new List<Parameter>() {
                        ...
                        new Parameter{ Name= "行走位", Addr = "D1007" ,Type = "一般参数" },
                        new Parameter{ Name= "取货位号", Addr = "D1009" ,Type = "一般参数" },
                        new Parameter{ Name= "放货位号", Addr = "D1008" ,Type = "一般参数" },
                        new Parameter{ Name= "货叉进", Addr = "D1010" ,Type = "一般参数" },
                        ...
                        new Parameter{ Name= "行走加速时间", Addr = "D2020" ,Type = "一般参数"},
                        new Parameter{ Name= "行走减速时间", Addr = "D2021" ,Type = "一般参数"},
                        new Parameter{ Name= "行走目标速度", Addr = "D2022" ,Type = "一般参数"},
                        new Parameter{ Name= "升降加速时间", Addr = "D2023" ,Type = "一般参数"},
                        new Parameter{ Name= "升降减速时间", Addr = "D2024" ,Type = "一般参数"},
                        new Parameter{ Name= "升降目标速度", Addr = "D2025" ,Type = "一般参数"},
                        new Parameter{ Name= "货叉加速时间", Addr = "D2026" ,Type = "一般参数"},
                        new Parameter{ Name= "货叉减速时间", Addr = "D2027" ,Type = "一般参数"},
                        new Parameter{ Name= "货叉目标速度", Addr = "D2028" ,Type = "一般参数"},
                        new Parameter{ Name= "货位号", Addr = "D2029" ,Type = "一般参数" },
                        ...
                        new Parameter{ Name= "行走位置参数", Addr = "D2042" ,Type = "一般参数"},
                        new Parameter{ Name= "升降1位置参数", Addr = "D2044" ,Type = "一般参数"},
                        new Parameter{ Name= "升降2位置参数", Addr = "D2046" ,Type = "一般参数"},
                        new Parameter{ Name= "货叉位置参数", Addr = "D2048" ,Type = "一般参数"},
                        new Parameter{ Name= "步号", Addr = "D2061" ,Type = "一般参数"},
                        ...
                        new Parameter{ Name= "调度无效", Addr = "D2075" ,Type = "手动自动状态"},
                        ...
                        new Parameter{ Name= "手动状态", Addr = "D1005" ,Type = "手动自动状态"},
                    };
                }
                return parameters;
            }
