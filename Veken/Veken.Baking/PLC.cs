...
namespace Veken.Baking
{
    public class PLC : TengDa.WF.Terminals.EthernetTerminal
    {
        ...
        public static int IsBakingValue
        {
            get
            {
                return TengDa._Convert.StrToInt(Current.option.IsBakingValue, -1);
            }
        }

        public static int IsNotBakingValue
        {
            get
            {
                return TengDa._Convert.StrToInt(Current.option.IsNotBakingValue, -1);
            }
        }
        #endregion
